...
for i in trip_advisor:
	...
	tripadvisor['SA'] = np.array([ analize_sentiment(comments) for comments in tripadvisor['comments'] ])
...
for i in agoda:
	...
	agoda['SA'] = np.array([ analize_sentiment(comments) for comments in agoda['comments'] ])
...
for i in booking:
	...
	booking['SA'] = np.array([ analize_sentiment(comments) for comments in booking['comments'] ])
